    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Prospyr Control</h1>
          <p className="text-slate-500">Operations Hub for Prospyr Inc.</p>
        </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="Franklin@simplifyingbusinesses.com"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 text-white font-medium rounded-xl transition-colors"
            >
              {loading ? (
        ...
        <p className="text-center text-slate-600 text-sm mt-6">
          Prospyr Inc. — Managing All Lines Auto, ALBS & ALBS Claims
        </p>
      </div>
    </div>
  )
